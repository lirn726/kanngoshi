...
?>
<form id="f" method="get" action="/ms/lp1/search_result.php">
   ...
   <div class="search_body">
        <table width="100%" cellpadding="0" cellspacing="5">
            ...
            <tr>
                <th>雇用形態</th>
                <td>
                    <select name="occupation" class="w100p h30">
                        <?php
                            foreach($occupation as $key => $val) {
                                echo "<option value='$key'" . (($i_2 == $key)?'selected':'') .">$val</option>\n";
                            }
                        ?>
                    </select>
                </td>
            ...
            <tr>
                <th>職種</th>
                <td>
                    <select name="work" class="w100p h30">
                        <?php
                            foreach($work as $key => $val) {
                                echo "<option value='$key'" . (($i_3 == $key)?'selected':'') .">$val</option>\n";
                            }
                        ?>
                    </select>
                </td>
            ...
            <tr>
                <th>施設形態</th>
                <td>
                    <select name="facility" class="w100p h30">
                        <?php
                            foreach($facility as $key => $val) {
                                echo "<option value='$key'" . (($i_4 == $key)?'selected':'') .">$val</option>\n";
                            }
                        ?>
                    </select>
                </td>
